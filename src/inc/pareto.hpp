...
namespace details {
  ...
  inline static void compare_pair(Pair& pair, Comparator&& compare) {
    ...
    auto result = std::invoke(
        std::forward<Comparator>(compare), fst.individual(), snd.individual());
...
template<std::ranges::forward_range Range, pareto_comparator<Range> Comparator>
...
template<std::ranges::viewable_range Range, pareto_comparator<Range> Comparator>
